...
<script>
    ...
    noneOption.addEventListener('mousedown', function (event) {
        // Prevent the default behavior to stop the checkbox from being unchecked
        event.preventDefault();
        noneClicked = !this.checked;
...
<div class="question" id="question8_1" style="display: none;">
    ...
    <div class="options">
        ...
        <div class="option">
            ...
            <label for="standardOption">Standard (150mm - 250mm) with 4S/6S battery and around 3" to 5" propellers</label>
        </div>
        <div class="option">
            <input type="radio" name="droneSize" value="longRange" id="longRangeOption">
            <label for="longRangeOption">Long-range (250mm or larger) with 6S/8S battery and around 5" to 7" propellers</label>
        </div>
        <div class="option">
